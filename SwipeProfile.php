        ...
        <div class="textchat_container">
            ...
            <div class="chat-side">
                ...
                <div class="chat-side__content">
                    <form class="chat-side__content-main" name="profile" id="profile" action="SwipeProfile.php"
                        ...
                        <div class="chat-side__content-filter__location">
                            ...
                            <select name="location" id="location">
                                ...
                                <option value="<?php echo htmlspecialchars($c["Address"]); ?>">
                        ...
                        <div class="card" id="profile-card-<?php echo $userId; ?>">
                            <div class="card-images-container">
                                <div class="card-wrapper">
                                    <div class="card-images">
                                        ...
                                        <img src="./assets/img/<?php echo htmlspecialchars($image); ?>"
                                            alt="Profile Image" class="card-image"
                                            style="display: <?php echo $idx === 0 ? 'block' : 'none'; ?>;"
                                            data-index="<?php echo $idx; ?>">
                                        <?php endforeach; ?>
                                        <?php else: ?>
                                        <img src="./assets/img/default-profile.jpg" alt="Profile Image"
                                            class="card-image" style="display: block;">
                                        <?php endif; ?>
                                    </div>
                                    <!-- Phân trang ảnh -->
                                ...
                                <!-- Thông tin user -->
                                <div class="profile-info" id="profile-info-<?php echo $userId; ?>"
                                    style="display: none;">
                                    <div class="info-item">
                            ...
                            <div class="card-action-buttons">
                                <button class="action-button dismiss-button"
                                    id="dismiss-button-<?php echo $userId; ?>"><img src="./assets/img/x.png"
                                        alt=""></button>
                                ...
                                <button class="action-button profile-button"
                                    id="profile-button-<?php echo $userId; ?>"><img src="./assets/img/user_white.png"
                                        alt=""></button>
    ...
    cards.forEach((card, i) => {
        ...
        if (profileBtn && profileInfo) {
            profileBtn.addEventListener('click', () => {
                profileInfo.style.display = (profileInfo.style.display === 'none' || profileInfo.style
                    .display === '') ? 'flex' : 'none';
            });
        }
